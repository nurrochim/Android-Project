...
import com.rohim.common.AppUtils;
...
public class FragmentMapLocationCapture extends BaseFragment implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener{
    ...
    public void initView() {
        view = inflater.inflate(R.layout.layout_location_capture, container,false);

        mapFragment = (SupportMapFragment) getChildFragmentManager().findFragmentById(R.id.map);
        mLocationMarkerText = (TextView) view.findViewById(R.id.locationMarkertext);
        mLocationAddress = (TextView) view.findViewById(R.id.text_addres);
        save = (Button) view.findViewById(R.id.button_save_map);
        cancel = (Button) view.findViewById(R.id.button_cancel_map);
        ...
        mLocationMarkerText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    final LatLng latLong = new LatLng(mCenterLatLong.latitude, mCenterLatLong.longitude);
                    marker = mMap.addMarker(new MarkerOptions()
                            .position(latLong)
                            .title("Coba")
                            .snippet("Survey Location")
                            .draggable(true)
                            .flat(true)
                    );
